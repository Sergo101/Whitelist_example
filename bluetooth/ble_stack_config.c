...
static void nus_data_handler(ble_nus_evt_t * p_evt)
{
    ...
    if (p_evt->type == BLE_NUS_EVT_RX_DATA)
    {
        ...
        //ble_input_data_copy (p_evt->params.rx_data.p_data, p_evt->params.rx_data.length);
    }
...
static void ble_evt_handler(ble_evt_t const * p_ble_evt, void * p_context)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_PARAMS_REQUEST:
            ...
            // Pairing not supported (changed by user)
        ...
        case BLE_GATTS_EVT_SYS_ATTR_MISSING:
            // No system attributes have been stored.(User: maybe disable this section)
    ...
    //nrf_ble_gatt_on_ble_evt (p_ble_evt,&m_gatt);
}
